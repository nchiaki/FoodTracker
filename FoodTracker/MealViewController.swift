...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    /*
     This value is either pass by 'MealTableViewController' in 'prepare(for:sender)'
     or constructed as part adding a new meal.
     */
    var meal: Meal?
    ...
    // This methodlets you configure a view controller before it's presented
